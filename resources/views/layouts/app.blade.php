...
<body class="menubar-left menubar-unfold menubar-dark pace-done theme-warning">
<!--============= start main area -->

<!-- APP NAVBAR ==========-->
<nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top warning in">
  ...
  <div class="navbar-container container-fluid">
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
      ...
      <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
        ...
        <li>
          <h5 class="page-title hidden-menubar-top hidden-float">{{ @$title }} | {{ config('app.name') }}</h5>
        </li>
      </ul>
          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu animated flipInY">
                <li>
                  <a class="text-color" href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout').submit();">
  ...
  <div class="wrap p-t-0">
    <footer class="app-footer">
      <div class="clearfix">
        @php
            $startYear = 2021;
            $period = date('Y') > $startYear ?  $startYear.' - '.date('Y') : date('Y');
        @endphp

        <div class="copyright pull-left">Copyright &copy; {{ $period }}. {{ config('app.name') }} | University Information Technology Services, KNUST</div>
      </div>
    </footer>
  </div>
  <!-- /#app-footer -->
